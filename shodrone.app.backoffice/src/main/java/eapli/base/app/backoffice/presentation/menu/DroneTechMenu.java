...
public class DroneTechMenu {
    ...
    private static final int SHOW_GENERATION_OPTION = 5;
    private static final int SPECIFY_PROGRAMMING_LANGUAGE_OPTION = 6;

    public Menu buildDroneMenu() {
        final Menu menu = new Menu("Drone >");
        //menu.addItem(CREATE_DRONE_MODEL_OPTION, "Create Drone Model",);
        //menu.addItem(ADD_DRONE_OPTION, "Add Drone to Inventory", );
        //menu.addItem(REMOVE_DRONE_OPTION, "Remove Drone from Inventory", );
